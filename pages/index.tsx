...
export default function Home() {
  ...
  return (
    <div className={`${geistSans.className} ${geistMono.className} min-h-screen bg-gray-50 flex items-center justify-center p-6`}>
      <main className="w-full max-w-md text-center space-y-6">
        ...
        <div className="mt-6 text-sm text-gray-600">
          ...
          />
          <p className="mt-2 text-xs text-gray-500">Si lo dejas vacío, se generará un ID automáticamente.</p>
        </div>
      </main>
    </div>
  );
